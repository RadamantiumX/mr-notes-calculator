...
app.use(express.static('../app/dist')) // Leemos los archivos estaticos de la APP
...
// para detectar si nuestra APP funciona correctamente
app.get('/health', (req, res) => {
  res.send('ok')
})

// Obtenemos la version del package.json
